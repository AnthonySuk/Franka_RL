...
class  FrankaRoughOnlyCfg(BaseConfig):
    class env:
        num_envs = 32 #8192
    ...
    class asset:
        ...
        #     sys.exit(1)
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/Panda/panda.urdf'
        name = 'tita_airbot'
        foot_name = []
...
class FrankaRoughOnlyCfgPPO(BaseConfig):
    seed = 1
    ...
    class runner:
        ...
        experiment_name = 'tita_airbot_rough'
        run_name = ''
        # load and resume
        resume = False
